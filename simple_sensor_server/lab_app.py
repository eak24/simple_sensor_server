...
import arrow
import random
from simple_sensor_readers import sensor_manager
...
def lab_temp():
	...
	sensor_readings = sensor_manager.get_sensor_readings()
	if sensor_readings is not None:
		return render_template("lab_temp.html",sensor_readings=sensor_readings)
	else:
